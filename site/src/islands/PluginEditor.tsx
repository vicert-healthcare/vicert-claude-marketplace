...
// ── Multi-file editor for a component type ──────────────────────────────────
...
// ── Folder / multi-file drag-and-drop uploader ──────────────────────────────
...
export default function PluginEditor() {
  ...
  // ── Parse uploaded / fetched files into form state ────────────────────
  ...
  }, [token, data, effectiveCategory, buildFiles, isEditing]);
      ...
      <div class="bg-gray-900 border border-gray-800 rounded-xl p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select value={data.category} onChange={update("category")} class={inputCls()} disabled={isEditing}>
              {categories.map((c) => (
